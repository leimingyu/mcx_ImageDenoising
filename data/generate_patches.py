...
def gen_osa_data_quicktest(photon_vol, 
        test_num = 100, 
        data_dir = './osa_data',
        ground_truth = './osa_data/1e+09',
        ground_truth_img_prefix = 'osa_1e9_img'):
    ...
    np.save(os.path.join(args.save_dir, "osa_img_noisy_pats_" + photon_vol+'_quicktest'), inputs_noisy)
    np.save(os.path.join(args.save_dir, "osa_img_clean_pats_" + photon_vol+'_quicktest'), inputs_clean)
