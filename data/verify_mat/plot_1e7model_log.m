...
load('1e7model-1e8-log_test1_img1.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 1 (10^8) with log : 1e7model')
...
load('1e7model-1e8-log_test1_img50.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 50 (10^8) with log : 1e7model')
...
load('1e7model-1e7-log_test1_img1.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 1 (10^7) with log : 1e7model ')
...
load('1e7model-1e7-log_test1_img50.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 50 (10^7) with log : 1e7model')
...
load('1e7model-1e6-log_test1_img1.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 1 (10^6) with log : 1e7model')
...
load('1e7model-1e6-log_test1_img50.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 50 (10^6) with log : 1e7model')
...
load('1e7model-1e5-log_test1_img1.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 1 (10^5) with log : 1e7model ')
...
load('1e7model-1e5-log_test1_img50.mat');
...
colorbar
xlabel('z axis'),ylabel('x axis')
title('image 50 (10^5) with log : 1e7model ')
