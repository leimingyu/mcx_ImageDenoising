...
def denoiser_train(denoiser, lr):
    ...
    #--------------------------------------------------------------------------
    noisy_data = np.load('../entire_images_datarotate_dncnnUnet/patches/osa_img_noisy_pats_1e+05.npy')
    clean_data = np.load('../entire_images_datarotate_dncnnUnet/patches/osa_img_clean_pats_1e+05.npy')
