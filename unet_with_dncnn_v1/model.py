...
def unet(input, is_training=True, output_channels=1):
    ...
    with tf.variable_scope('down0'):
        # conv + conv + max_pool
        down0a = tc.layers.conv2d(input_unet,  32,  (3,3), padding='same', normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        down0b = tc.layers.conv2d(down0a, 32,  (3,3), padding='same', normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        down0c = tc.layers.max_pool2d(down0b,  (2,2), padding='same')

    with tf.variable_scope('down1'):
        down1a = tc.layers.conv2d(down0c,  256, (3,3), padding='same', normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        down1b = tc.layers.conv2d(down1a,  256, (3,3), padding='same', normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
    ...
    with tf.variable_scope('up1'):
        up1a = tc.layers.conv2d_transpose(down2b, 256, (2,2), 2, normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        up1b = tf.concat([up1a, down1b], axis=3)
        up1c = tc.layers.conv2d(up1b, 256, (3,3), normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        up1d = tc.layers.conv2d(up1c, 256, (3,3), normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        up1e = tc.layers.conv2d(up1d, 256, (3,3), normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})

    with tf.variable_scope('up0'):
        up0a = tc.layers.conv2d_transpose(up1e, 32, (2,2), 2, normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        up0b = tf.concat([up0a, down0b], axis=3)
        up0c = tc.layers.conv2d(up0b, 32, (3,3), normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        up0d = tc.layers.conv2d(up0c, 32, (3,3), normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
        up0e = tc.layers.conv2d(up0d, 32, (3,3), normalizer_fn=tc.layers.batch_norm, normalizer_params={'is_training': is_training})
